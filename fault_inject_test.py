...
def inj_model(model_name,BER,error_mode,protection,device="cuda",choice_device="",test=False):
...
inj_model(model_name="../model/yolov4_SECDED.pt",BER=1e-1,error_mode="bf",protection=8.1,test=False)#,choice_device="cupy")